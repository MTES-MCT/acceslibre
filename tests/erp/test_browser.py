...
def test_ajout_erp(client):
    ...
    assert accessibilite.completion_rate == 23
    ...
    response = client.post(
        ...
        data={
            ...
            "cheminement_ext_ascenseur_pmr": False,
        },
        follow=True,
    )
    accessibilite = Accessibilite.objects.get(erp__slug=erp.slug)
    ...
    assert accessibilite.completion_rate == 71
    ...
    assert accessibilite.completion_rate == 89
