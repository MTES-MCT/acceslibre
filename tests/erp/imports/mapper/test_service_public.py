...
def test_save_non_existing_erp(mapper, service_public_valid):
    ...
    assert erp.code_insee == "77188"
    assert erp.geom.coords == (2.75745010376, 48.4868011475)
...
def test_update_existing_erp(mapper, service_public_valid):
    ...
    existing_erp = ErpFactory(source=Erp.SOURCE_SERVICE_PUBLIC, source_id="mairie-77188-01", commune="Fontaine-le-Poux")
