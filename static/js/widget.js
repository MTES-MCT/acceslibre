...
// TODO remove me
function _loadDismissTrigger(dismissTrigger, trigger = null) {
...
function loadTriggers() {
  ...
  triggers.forEach((trigger) => {
    ...
    dismissTriggers.forEach((dismissTrigger) => {
      _loadDismissTrigger(dismissTrigger, trigger)
    })
  })
}

function _trackOnClick(element, trackingString) {
  console.log('In _trackOnClick')
...
function trackEventOnClose() {
  console.log('in trackEventOnClose')
...
function showAccessibilityModal(uuid) {
