        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Identifiant unique de l'enregistrement importé (si disponible)",
                        max_length=255,
                        null=True,
                    ),
                ),
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            (
                                "attestation",
                                "Attestation d’accessibilité pour un etablissement conforme",
                            ),
                            ("adap", "Ad’AP: Agenda d’accessibilité programmé"),
                            (
                                "adap_s",
                                "Ad’AP-S: Agenda d’accessibilité programmé simplifié",
                            ),
                            (
                                "at_adap",
                                "AT Ad’AP: Agenda d’axs prog associé à une autorisation de travaux",
                            ),
                        ],
                        help_text="Type de dossier",
                        max_length=12,
                    ),
                ),
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Numéro d’autorisation pour suivi interne (num attestation, num at-adap…). Proposition de format pour attestations\xa0: «\xa0AC-X-Y\xa0» X = numéro département / Y = numéro de l’attestation",
                        max_length=255,
                        null=True,
                    ),
                ),
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Identité du demandeur",
                        max_length=255,
                        null=True,
                    ),
                ),
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="type d’activité\xa0: liste SDIS - si plusieurs activités séparées par des virgules sans espaces (,).",
                        max_length=255,
                        null=True,
                    ),
                ),
                (
                    ...
                    models.CharField(
                        blank=True,
                        choices=[("erp", "ERP"), ("iop", "IOP")],
                        help_text="ERP ou IOP",
                        max_length=255,
                        null=True,
                    ),
                ),
                (
                    ...
                    models.IntegerField(
                        ...
                        help_text="Catégorie si ERP (1 à 5)",
                        null=True,
                    ),
                ),
                (
                    ...
                    models.DateField(
                        blank=True,
                        help_text="Date de validation de l’Ad’AP ou d’enregistrement de l’attestation",
                        null=True,
                    ),
                ),
                (
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text="Point de non conformité concerné par la dérogation",
                        null=True,
                    ),
                ),
                (
