...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            model_name='erp',
            name='itm_id',
            field=models.CharField(help_text="Identifiant de l'ERP dans la base Service Public", max_length=255, null=True, verbose_name='ITM ID'),
        ),
        migrations.AlterField(
            model_name='accessibilite',
            name='accueil_equipements_malentendants',
            field=django.contrib.postgres.fields.ArrayField(base_field=models.CharField(blank=True, choices=[('bim', 'boucle à induction magnétique fixe'), ('bmp', 'boucle à induction magnétique portative'), ('lsf', 'langue des signes française (LSF)'), ('lpc', 'langue française parlée complétée (LFPC)'), ('sts', 'sous-titrage ou transcription simultanée'), ('autres', 'autres')], max_length=255), blank=True, default=list, null=True, size=None, verbose_name='Équipement(s) sourd/malentendant'),
        ),
        migrations.AlterField(
            model_name='activite',
            name='position',
            field=models.PositiveSmallIntegerField(default=erp.models.get_last_position, verbose_name='Position dans la liste'),
        ),
        migrations.AlterField(
            model_name='erp',
            name='source',
