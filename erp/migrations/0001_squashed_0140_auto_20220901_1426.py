...
class Migration(migrations.Migration):
    ...
    replaces = [
        ...
        ("erp", "0135_rename_cheminement_ext_terrain_accidente_accessibilite_cheminement_ext_terrain_stable"),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("nom", models.CharField(help_text="Nom de l'activité", max_length=255, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ("id", models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name="ID")),
                ("nom", models.CharField(help_text="Nom du label", max_length=255, unique=True)),
                ("created_at", models.DateTimeField(auto_now_add=True, verbose_name="Date de création")),
                ("updated_at", models.DateTimeField(auto_now=True, verbose_name="Dernière modification")),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ("id", models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name="ID")),
                ("nom", models.CharField(help_text="Nom de l'établissement ou de l'enseigne", max_length=255)),
                (
                    "siret",
                    models.CharField(
                        blank=True,
                ...
                ("voie", models.CharField(blank=True, help_text="Voie", max_length=255, null=True)),
                ("lieu_dit", models.CharField(blank=True, help_text="Lieu dit", max_length=255, null=True)),
                ("code_postal", models.CharField(help_text="Code postal", max_length=5)),
                ("commune", models.CharField(help_text="Nom de la commune", max_length=255)),
                ("code_insee", models.CharField(blank=True, help_text="Code INSEE", max_length=5, null=True)),
                (
                    "activite",
                    models.ForeignKey(
                        blank=True,
                ...
                (
                    "site_internet",
                    models.URLField(
                        blank=True, help_text="Adresse du site internet de l'ERP", max_length=255, null=True
                    ),
                ),
                (
                    "telephone",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ("id", models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name="ID")),
                ("nom", models.CharField(help_text="Nom de l'équipement", max_length=255, unique=True)),
                ("created_at", models.DateTimeField(auto_now_add=True, verbose_name="Date de création")),
                ("updated_at", models.DateTimeField(auto_now=True, verbose_name="Dernière modification")),
            ],
            options={
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True, help_text="Labels d'accessibilité obtenus par l'ERP", to="erp.Label"
                    ),
                ),
                (
                    "erp",
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True, to="erp.EquipementMalentendant", verbose_name="Équipements sourds/malentendants"
                    ),
                ),
                (
                    "aide_humaine",
                    models.BooleanField(
                        blank=True, help_text="Présence ou possibilité d'une aide humaine au déplacement", null=True
                    ),
                ),
                (
                    "ascenseur",
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        choices=[(None, "Inconnu"), ("aucune", "Aucune"), ("fixe", "Fixe"), ("amovible", "Amovible")],
                ...
                (
                    "entree_plain_pied",
                    models.BooleanField(
                        blank=True, help_text="L'entrée est-elle de plain-pied ?", null=True, verbose_name="Plain-pied"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        choices=[(None, "Inconnu"), ("aucun", "Aucun"), ("léger", "Léger"), ("important", "Important")],
                ...
                (
                    "accessibilite",
                    models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="erp.accessibilite"),
                ),
                (
                    "escalier_reperage",
                    models.BooleanField(
        ...
        migrations.AlterField(
            ...
            field=models.BooleanField(
                blank=True,
                choices=[(None, "Inconnu ou sans objet"), (True, "Oui"), (False, "Non")],
                help_text="La zone d'accueil est-elle visible depuis l'entrée ?",
                null=True,
        ...
        migrations.AlterField(
            ...
            name="type",
            field=models.CharField(
                choices=[("int", "Cheminement intérieur"), ("ext", "Cheminement extérieur")],
                default="ext",
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                blank=True,
                choices=[("aucune", "Aucune"), ("fixe", "Fixe"), ("amovible", "Amovible"), (None, "Inconnu")],
                help_text="Présence et type de rampe",
                max_length=20,
                null=True,
            ),
        ...
        migrations.AlterField(
            ...
            name="slug",
            field=autoslug.fields.AutoSlugField(
                default="", editable=False, help_text="Identifiant d'URL (slug)", populate_from="nom", unique=True
            ),
        ),
        migrations.AlterField(
            model_name="cheminement",
        ...
        migrations.AddField(
            ...
            name="entree_marches",
            field=models.PositiveSmallIntegerField(
                blank=True, help_text="Nombre de marches d'escalier", null=True, verbose_name="Marches d'escalier"
            ),
        ),
        migrations.AddField(
            model_name="accessibilite",
        ...
        migrations.AddField(
            ...
            field=django.contrib.postgres.fields.ArrayField(
                base_field=models.CharField(
                    blank=True,
                    choices=[("auditif", "Auditif"), ("mental", "Mental"), ("moteur", "Moteur"), ("visuel", "Visuel")],
                    max_length=255,
                ),
                blank=True,
                default=list,
        ...
        migrations.AlterField(
            ...
            name="code_insee",
            field=models.CharField(
                blank=True, help_text="Code INSEE de la commune", max_length=5, null=True, verbose_name="Code INSEE"
            ),
        ),
        migrations.AddField(
            model_name="accessibilite",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "departement",
                    models.CharField(
                        help_text="Codé sur deux ou trois caractères.", max_length=3, verbose_name="Département"
                    ),
                ),
                (
                    "code_insee",
                    models.CharField(help_text="Code INSEE de la commune", max_length=5, verbose_name="Code INSEE"),
                ),
                (
                    "superficie",
                    models.PositiveIntegerField(
                        blank=True, help_text="Exprimée en hectares (ha)", null=True, verbose_name="Superficie"
                    ),
                ),
                (
                    "geom",
                ...
                (
                    "population",
                    models.PositiveIntegerField(
                        blank=True, help_text="Nombre d'habitants estimé", null=True, verbose_name="Population"
                    ),
                ),
            ],
            options={
        ...
        migrations.AlterField(
            ...
            name="accueil_prestations",
            field=models.TextField(
                blank=True, max_length=1000, null=True, verbose_name="Prestations d'accueil adapté supplémentaires"
            ),
        ),
        migrations.AlterField(
            model_name="accessibilite",
        ...
        migrations.AlterField(
            ...
            field=models.TextField(blank=True, max_length=500, null=True, verbose_name="Infos entrée spécifique PMR"),
        ),
        migrations.AlterField(
            model_name="accessibilite",
            name="entree_reperage",
        ...
        migrations.AlterField(
            model_name="accessibilite",
            name="transport_information",
            field=models.TextField(blank=True, max_length=1000, null=True, verbose_name="Informations transports"),
        ),
        migrations.AlterField(
            model_name="accessibilite",
            name="transport_station_presence",
        ...
        migrations.AddField(
            ...
            field=models.CharField(
                ...
                choices=[
                    ...
                    ("attestation", "L'établissement a envoyé une attestation d’accessibilité"),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ("id", models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name="ID")),
                ("value", models.SmallIntegerField(choices=[(-1, "-1"), (1, "+1")], default=1, verbose_name="Valeur")),
                ("comment", models.TextField(blank=True, max_length=5000, null=True, verbose_name="Commentaire")),
                ("created_at", models.DateTimeField(auto_now_add=True, verbose_name="Date de création")),
                ("updated_at", models.DateTimeField(auto_now=True, verbose_name="Dernière modification")),
                (
                    "erp",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="erp.erp", verbose_name="Établissemet"
                    ),
                ),
                (
                    "user",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("last_checked", models.DateTimeField(auto_now=True, verbose_name="Dernière vérification")),
                (
                    "erp",
                    models.OneToOneField(
                        on_delete=django.db.models.deletion.CASCADE, to="erp.erp", verbose_name="Établissement"
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                blank=True,
                choices=[("aucun", "Aucun"), ("léger", "Léger"), ("important", "Important"), (None, "Inconnu")],
                max_length=15,
                null=True,
                verbose_name="Dévers",
            ),
        ...
        migrations.AddField(
            ...
            field=models.CharField(
                blank=True,
                choices=[("montant", "Montant"), ("descendant", "Descendant"), (None, "Inconnu")],
                max_length=20,
                null=True,
        ...
        migrations.AddField(
            ...
            field=models.CharField(
                blank=True,
                choices=[("aucune", "Aucune"), ("légère", "Légère"), ("importante", "Importante"), (None, "Inconnu")],
                max_length=15,
                null=True,
        ...
        migrations.AddField(
            ...
            field=models.CharField(
                blank=True,
                choices=[("courte", "< 0,5m"), ("moyenne", "entre 0,5 et 2m"), ("longue", "> 2m"), (None, "Inconnu")],
                max_length=15,
                null=True,
        ...
        migrations.AddField(
            ...
            field=models.CharField(
                blank=True,
                choices=[("manuelle", "Manuelle"), ("automatique", "Automatique"), (None, "Inconnu ou sans objet")],
                max_length=255,
                null=True,
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                blank=True,
                choices=[("légère", "Légère"), ("importante", "Importante"), (None, "Inconnu")],
                max_length=15,
                null=True,
                verbose_name="Difficulté de la pente",
            ),
        ...
        migrations.AlterField(
            ...
            field=django.contrib.postgres.fields.ArrayField(
                base_field=models.CharField(
                    blank=True,
                    choices=[("bouton", "Bouton d’appel"), ("interphone", "Interphone"), ("visiophone", "Visiophone")],
                    max_length=255,
                ),
                blank=True,
                default=list,
        ...
        migrations.AddField(
            ...
            field=django.contrib.gis.db.models.fields.MultiPolygonField(
                help_text="Contour de la commune", null=True, srid=4326, verbose_name="Contour"
            ),
        ),
        migrations.AddField(
            model_name="commune",
        ...
        migrations.AlterField(
            ...
            name="entree_porte_presence",
            field=models.BooleanField(
                blank=True, choices=[(True, "Oui"), (False, "Non")], null=True, verbose_name="Y a-t-il une porte ?"
            ),
        ),
        migrations.AlterField(
            model_name="erp",
