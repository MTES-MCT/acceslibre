...
def challenge_ddt(request):
    ...
    emails_players_list = [
        ...
        "sophie.degualy@equipement-agriculture.gouv.fr",
        "isabelle.plagnes@landes.gouv.fr",
        ...
        "philippe.josserand@tarn-et-garonne.gouv.fr",
        "magali.gregoire@tarn-et-garonne.gouv.fr",
        "laurence.dreuilhe-recoules@tarn-et-garonne.gouv.fr",
        "magalie.rivalleau@tarn-et-garonne.gouv.fr",
        ...
        "sebastien.noguelou@haut-rhin.gouv.fr",
