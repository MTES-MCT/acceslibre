...
from erp.management.utils import print_error, print_warning
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        qs = Accessibilite.objects.filter(entree_dispositif_appel__in=[None, False]).exclude(
