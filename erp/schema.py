...
PARTNER_LABELS = {
    ...
    "ESTABLISHMENT_MANAGER": translate_lazy("Gestionnaire d'établissements"),
    "INSTITUTIONAL": translate_lazy("Institutionnel"),
    "ASSOCIATION": translate_lazy("Association"),
    "COMMUNITY": translate_lazy("Collectivité"),
    "GENERAL_INFORMATION_SITE": translate_lazy("Site d'informations générales"),
    "STUDY_OFFICE": translate_lazy("Bureau d'étude"),
    "SERVICE_DEDICATED_TO_PEOPLE_WITH_DISABILITIES": translate_lazy("Service dédié aux personnes handicapées"),
}

PARTNER_ROLES = {"RE_USE": "RE_USE", "COLLECTOR": "COLLECTOR"}
...
PARTENAIRES = {
    ...
    "PATHE": {
        ...
        "labels": [PARTNER_LABELS["TOURISM_AND_LEISURE"], PARTNER_LABELS["ESTABLISHMENT_MANAGER"]],
        "roles": [PARTNER_ROLES["RE_USE"], PARTNER_ROLES["COLLECTOR"]],
    },
    "GROUPE_BERTRAND": {
    ...
    "AGGLOMERATION_LORIENT": {
        ...
        "labels": [PARTNER_LABELS["COMMUNITY"], PARTNER_LABELS["SERVICE_DEDICATED_TO_PEOPLE_WITH_DISABILITIES"]],
        "roles": [PARTNER_ROLES["RE_USE"], PARTNER_ROLES["COLLECTOR"]],
    },
