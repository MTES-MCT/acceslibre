...
class AccessibilityImportSerializer(serializers.ModelSerializer):
    ...
    cheminement_ext_signaletique_exterieure = NullBooleanField(required=False, allow_null=True)
    ...
    accueil_signaletique_interieure = NullBooleanField(required=False, allow_null=True)
