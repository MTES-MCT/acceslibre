    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "referer",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="implementations", to="stats.referer"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "challenge",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT, to="stats.challenge", verbose_name="Challenge"
                    ),
                ),
                (
                    "player",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL, verbose_name="Joueur"
                    ),
                ),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                related_name="challenge_players", through="stats.ChallengePlayer", to=settings.AUTH_USER_MODEL
            ),
        ),
        migrations.AlterField(
